...
public class colors extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strListView = getResources().getStringArray(R.array.colors);
        ...
        ArrayAdapter<String> objAdapter = new ArrayAdapter<String>(colors.this, android.R.layout.simple_list_item_1, strListView);
