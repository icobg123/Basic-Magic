...
public class mana extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strListView = getResources().getStringArray(R.array.mana);
        ...
        ArrayAdapter<String> objAdapter = new ArrayAdapter<String>(mana.this, android.R.layout.simple_list_item_1, strListView);
