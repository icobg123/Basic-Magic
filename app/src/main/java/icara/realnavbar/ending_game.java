...
public class ending_game extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strListView = getResources().getStringArray(R.array.ending_the_game);
        ...
        ArrayAdapter<String> objAdapter = new ArrayAdapter<String>(ending_game.this, android.R.layout.simple_list_item_1, strListView);
