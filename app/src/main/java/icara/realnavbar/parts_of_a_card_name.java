...
public class parts_of_a_card_name extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strListView = getResources().getStringArray(R.array.general_rules);
        ...
        ArrayAdapter<String> objAdapter = new ArrayAdapter<String>(parts_of_a_card_name.this, android.R.layout.simple_list_item_1, strListView);
