...
public class player_rules  extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strListView = getResources().getStringArray(R.array.player_rules);
        ...
        ArrayAdapter<String> objAdapter = new ArrayAdapter<String>(player_rules.this, android.R.layout.simple_list_item_1, strListView);
