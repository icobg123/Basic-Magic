...
public class StandalonePlayerDemoActivity extends Activity implements View.OnClickListener {
  ...
  private static final String mVIDEO_ID = "cdgQpa1pUUE";
  private static final String PLAYLIST_ID =  "7E952A67F31C58A3";
  private static final ArrayList<String> mVIDEO_IDS = new ArrayList<String>(Arrays.asList(
  ...
  public void onClick(View v) {
    ...
    if (v == playVideoButton) {
      intent = YouTubeStandalonePlayer.createVideoIntent(
          this, DeveloperKey.DEVELOPER_KEY, mVIDEO_ID, startTimeMillis, autoplay, lightboxMode);
      ...
      intent = YouTubeStandalonePlayer.createVideosIntent(this, DeveloperKey.DEVELOPER_KEY,
          mVIDEO_IDS, startIndex, startTimeMillis, autoplay, lightboxMode);
    }
